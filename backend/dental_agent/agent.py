...
## Booking Rules
- Always call check_slot_availability before booking
...
def _pre_model_hook(state: dict) -> dict:
    """
    Runs before every LLM call inside the ReAct loop.

    Ensures messages are sanitized and prepends the system prompt.
    """
